...
def create_simulation_form():
    ...
    return dbc.Card([
        dbc.CardHeader([
            html.Div([
                html.H5("Nouvelle Simulation", className="mb-0"),
                dbc.Button("×", color="light", size="sm", id={"type": "remove_sim", "index": simulation_id})
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.DatePickerSingle(
                        ...
                        clearable=True,
                        style={'width': '100%'},
                        # Plage de dates valides (par exemple, dernières 5 années)
...
def layout():
    return dbc.Container([
        ...
        html.Div(id="simulations-container", children=[create_simulation_form()]),
